-- Migration to restructure from doctor-centric to clinic-centric system
-- This creates the foundation for multi-user clinics with role-based access
...
CREATE TABLE IF NOT EXISTS public.clinic_members (
  ...
  -- Ensure only one owner per clinic
  UNIQUE(clinic_id, role) WHERE role = 'owner'
);
